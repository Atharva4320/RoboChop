...
class SkillUtils():
	...
	def observe_scene_multiclass(self, messenger, obs_pose, classes):
		"""
		...
		messenger.send_object(object = "Segment", name = "Segment")
		print("Sent message...")
		# message = None
		# while message is None:
			# message, = udp.ReadReceivedData()
		objs, message_name = messenger.receive_object()
		print("Message name: ", message_name, " - Message: ", objs)
...
# -------- FUNCTIONS FOR SINGLE CLASS ONLY -----------
	def observe_scene(self, messenger, obs_pose):
		# goto observation pose
		print("\nGo to observation pose...")
		self.fa.goto_pose(obs_pose)
		time.sleep(0.5)
